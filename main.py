...
def peliculas_mes(mes: str):
    ...
    #Si la productora ingresada no esta en las productora del dataset devolvemos el mensaje que no se tiene datos del valor ingresado
    if mes not in df_mes.values:
        return {'mensaje': "No se tienen datos del mes ingresado" }
    else:
...
def peliculas_dia(dia: str):
    ...
    #Si la productora ingresada no esta en las productora del dataset devolvemos el mensaje que no se tiene datos del valor ingresado
    if dia not in df_dia.values:
        return {'mensaje': "No se tienen datos del dia ingresado" }
    else:
...
def franquicia(franquicia: str):
    ...
    #Si la productora ingresada no esta en las productora del dataset devolvemos el mensaje que no se tiene datos del valor ingresado
    if franquicia not in df_franquicia.values:
        return {'mensaje': "No se tienen datos de la franquicia ingresada" }
    else:
...
def peliculas_pais(pais: str):
   # Nos quedamos solo con un dataframe con las peliculas de ese pais proporcionado
    ...
    #Si la productora ingresada no esta en las productora del dataset devolvemos el mensaje que no se tiene datos del valor ingresado
    if pais not in df_pais.values:
        return {'mensaje': "No se tienen datos del pais ingresado" }
    else:
...
def productoras(productora: str):
    ...
    #Si la productora ingresada no esta en las productora del dataset devolvemos el mensaje que no se tiene datos del valor ingresado
    if productora not in df_pc.values:
        return {'mensaje': "No se tienen datos de la productora ingresada" }
    else:
...
def retorno(pelicula: str):
   #Si la pelicula ingresada no esta en los titulos del dataset devolvemos el mensaje que no se tiene datos del valor ingresado
    if pelicula not in data['title'].values:
